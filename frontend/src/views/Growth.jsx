...
function Stat({label,value,detail}){return <div style={{padding:10,background:"var(--bg-sunken)",border:"1px solid var(--line-hairline)",borderRadius:6}}><div className="rowmeta">{label}</div><div style={{fontSize:20,fontWeight:600}}>{value}</div><div className="rowmeta">{detail}</div></div>;}
