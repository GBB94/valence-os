...
- **Remaining:** Stage 5 champion/influence/exec/messaging/dynamics **+ the deferred §4.4 extraction targets** (next), Stage 6 generators, Stage 7 triggers+calendar+change-detection, Stage 8 CONNECTIONS.md + e2e demo.
