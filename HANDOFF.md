...
**Running Phase 3 test count: 233** (was 67 at Phase 2 close). Backend still requires Python 3.12 (`.venv/bin/python -m pytest`).
...
- `stage-0/field-dictionary.md` — the baseline object/field set; the fence where the active additive specs are silent (invariant #6).
- `docs/archive/` — superseded briefs and retrospective evidence, history only.
- `docs/README.md` — documentation map; runbooks and historical evidence live below it.
