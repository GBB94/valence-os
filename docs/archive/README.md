...
Point-in-time briefs and working documents that have been **fully executed and
superseded**. Kept for history; none of them describe the current state of the
project — for that, read `README.md`, `HANDOFF.md`, and `PHASE-3-SPEC.md` at the
repo root, and the newest-first log in `decisions.md`.
